...
(function () {
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME = "requests.data";
    var REMOTE_PACKAGE_BASE = "requests.data";
    ...
    function runWithFS() {
      ...
      Module["FS_createPath"]("/lib/python3.9", "site-packages", true, true);
      Module["FS_createPath"]("/lib/python3.9/site-packages", "requests", true, true);
      Module["FS_createPath"]("/lib/python3.9/site-packages", "requests-2021.11.3-py3.8.egg-info", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_requests.data")
      }

      Module["addRunDependency"]("datafile_requests.data");
